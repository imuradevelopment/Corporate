...
<header class="fixed top-0 w-full bg-gray-900/95 backdrop-blur-sm border-b border-gray-800 shadow-lg z-50">
    <nav class="container mx-auto px-6 py-4">
            ...
            <div class="flex items-center">
                <a href="index.html" class="flex items-center">
                    ...
                    <svg class="w-10 h-10 mr-2" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- 脳のシルエット -->
                        <path d="M50 10 C30 10 15 25 15 45 C15 65 30 80 50 80 C70 80 85 65 85 45 C85 25 70 10 50 10 Z" fill="#38bdf8" />
                        <!-- ニューラルネットワークのドット -->
                    ...
                    <span class="text-2xl font-bold text-sky-400 cyber-text">AI-Dev's</span>
                </a>
            </div>
            
            <!-- デスクトップメニュー -->
            <div class="hidden md:flex items-center space-x-8">
                <a href="index.html" class="nav-link text-gray-300 hover:text-sky-400 transition">ホーム</a>
                <a href="services.html" class="nav-link text-gray-300 hover:text-sky-400 transition">サービス</a>
                <a href="about.html" class="nav-link text-gray-300 hover:text-sky-400 transition">会社概要</a>
                <a href="portfolio.html" class="nav-link text-gray-300 hover:text-sky-400 transition">実績</a>
                <a href="contact.html" class="nav-link bg-sky-500 text-gray-900 px-6 py-2 rounded-lg hover:bg-sky-400 transition">お問い合わせ</a>
            </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-4 pb-4">
            <a href="index.html" class="block py-2 text-gray-300 hover:text-sky-400 transition">ホーム</a>
            <a href="services.html" class="block py-2 text-gray-300 hover:text-sky-400 transition">サービス</a>
            <a href="about.html" class="block py-2 text-gray-300 hover:text-sky-400 transition">会社概要</a>
            <a href="portfolio.html" class="block py-2 text-gray-300 hover:text-sky-400 transition">実績</a>
            <a href="contact.html" class="block mt-4 bg-sky-500 text-gray-900 text-center px-6 py-2 rounded-lg hover:bg-sky-400 transition">お問い合わせ</a>
        </div>
    </nav>
</header>`,
            footer: `<!-- フッター -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <div class="flex items-center mb-4">
                    ...
                    <span class="text-xl font-bold text-sky-400">AI-Dev's</span>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><a href="services.html" class="hover:text-sky-400 transition">AI開発</a></li>
                    <li><a href="services.html" class="hover:text-sky-400 transition">データ分析</a></li>
                    <li><a href="services.html" class="hover:text-sky-400 transition">システム開発</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><a href="about.html" class="hover:text-sky-400 transition">会社概要</a></li>
                    <li><a href="portfolio.html" class="hover:text-sky-400 transition">実績</a></li>
                    <li><a href="contact.html" class="hover:text-sky-400 transition">お問い合わせ</a></li>
                </ul>
            </div>
